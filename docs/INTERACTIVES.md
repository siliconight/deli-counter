...
| `vault`        | `vault_door` — `[locked, unlocked, open, breached]`, `state_geometry {locked: vault_door, unlocked: vault_door, open: vault_door, breached: vault_door}` (Zoo draws every state; 0.130.0) | **inferred** (always) |
